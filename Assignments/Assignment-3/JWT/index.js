...
function signJwt(username, password) {
    const parseUsername = emailSchema.safeParse(username);
    const parsePassword = passwordSchema.safeParse(password);
    
    if(parsePassword.success===false || parseUsername.success === false){
        return null;
    }
...
// const token = signJwt("priyam@gmail.com", "password")
// decodeJwt(token)
